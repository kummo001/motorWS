...
/****** Object:  Database [Webservice]    Script Date: 3/8/2021 1:03:43 AM ******/
CREATE DATABASE [Webservice]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Webservice', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Webservice.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Webservice_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\Webservice_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Webservice] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [Webservice] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [Webservice] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [Webservice] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
